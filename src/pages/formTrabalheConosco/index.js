  ...
  return (
    <form id="registerTeacherForm">
      ...
      <div className="work">
        ...
        <h4>Cadastre seu currículo e participe das nossas seleções para ser um dos nossos colaboradores</h4>
        <br />
        <hr /><br />
      </div>
      ...
      <div className="form-group">
        ...
        <input type="tel" name="phone" pattern="[0-9]{2} [0-9]{5}-[0-9]{4}" id="i-tel" placeholder="99 99999-9999" required />
      </div>

      <div className="form-group">
        <label htmlFor="i-tel2">Telefone 2:</label>
        <input type="tel" name="phone" pattern="[0-9]{2} [0-9]{5}-[0-9]{4}" id="i-tel2" placeholder="99 99999-9999" />
      </div>

      <div className="form-group">
        <label htmlFor="cpf">CPF:*</label>
        <input type="text" id="cpf" name="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" placeholder="000.000.000-00" title="CPF deve estar no formato 000.000.000-00" required />
      </div>

      <div className="form-group">
        <label htmlFor="i-date">Qual a data do seu nascimento?</label>
        <input type="date" name="bday" id="i-date" max="2021-11-03" /><br /><br />
      </div>
      ...
      <div className="form-group">
        ...
        <select id="cargo" name="cargo" required>
          <option value="" selected disabled hidden>Selecione</option>
          <option value="Professor de Lógica de Programação">Professor de Lógica de Programação</option>
          <option value="Professor especialista em IOT">Professor especialista em IOT</option>
          <option value="Professor especialista em IA">Professor especialista em IA</option>
          <option value="Auxiliar Administrativo">Auxiliar Administrativo</option>
          <option value="Estágio em atendimento ao cliente">Estágio em atendimento ao cliente</option>
        </select>
      </div>
      ...
      <div className="form-group">
        ...
        <input type="password" id="register-confirm-password" name="confirm-password" placeholder="Confirme sua senha" required />
      </div>
